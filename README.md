...
- Script de chiffrement WEP **abondamment commenté/documenté**
  ...
  *Le script se trouve dans le fichier `manual-encryption.py`.*

  *Le pcap est stocké dans `arpForged.cap`.*

  *La capture d'écran correspondante est dans `decrypted_data_1.png`.*
...
- Script de fragmentation **abondamment commenté/documenté**
  ...
  *Le script se trouve dans le fichier `manual-encryption_fragmentation.py`.*

  *Le pcap est stocké dans `fragmentsForged.cap`.*

  *La capture d'écran correspondante est dans `decrypted_data_2.png`.*
